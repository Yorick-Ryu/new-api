...
func channelMatchesFilter(ch *Channel, modelName string, filter dto.ChannelFilter) bool {
	...
	case dto.FilterResponsesTransport:
		return ch.SupportsResponsesTransport(filter.ResponsesTransport, modelName)
	case dto.FilterResponsesWebSocket:
		return ch.SupportsResponsesTransport(constant.ResponsesTransportWebSocket, modelName)
	default:
		return true
	}
}
