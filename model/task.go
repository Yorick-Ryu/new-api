...
type TaskPrivateData struct {
	...
	SubscriptionModelMultiplier    float64             `json:"subscription_model_multiplier,omitempty"`
	SubscriptionGroupRatio         float64             `json:"subscription_group_ratio,omitempty"`
	SubscriptionOriginalGroupRatio *float64            `json:"subscription_original_group_ratio,omitempty"`
