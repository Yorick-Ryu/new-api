...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&UserSubscriptionQuotaWindow{}, "UserSubscriptionQuotaWindow"},
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "allow_renewal", DDL: "`allow_renewal` numeric"},
		...
		{Name: "quota_windows", DDL: "`quota_windows` text"},
		{Name: "model_multipliers", DDL: "`model_multipliers` text"},
