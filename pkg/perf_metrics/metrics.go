...
func QuerySummaryAll(hours int, groups []string) (SummaryAllResult, error) {
	...
	for name, total := range totals {
		...
		all.inputTokens += total.inputTokens
		all.cacheReadTokens += total.cacheReadTokens
	...
	return SummaryAllResult{Summary: summarize(all), WindowStart: startTs, WindowEnd: endTs, Models: models, CacheHitRate: cacheHitRate(all)}, nil
}
