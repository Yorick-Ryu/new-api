...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/service-status", middleware.UserAuth(), controller.GetServiceStatus)
		apiRouter.GET("/service-status/settings", middleware.AdminAuth(), controller.GetServiceStatusSettings)
		apiRouter.PUT("/service-status/settings", middleware.AdminAuth(), controller.UpdateServiceStatusSettings)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/users/:id/subscriptions/:subscription_id/renew", controller.AdminRenewUserSubscription)
		...
		dataRoute.GET("/business", middleware.AdminAuth(), controller.GetBusinessDashboard)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/display_order", controller.GetModelDisplayOrder)
			modelsRoute.PUT("/display_order", controller.UpdateModelDisplayOrder)
