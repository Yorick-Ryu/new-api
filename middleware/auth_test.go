...
func TestAPIKeyFromWebSocketSubprotocol(t *testing.T) {
	tests := []struct {
		...
		{name: "responses protocol only", protocols: "responses", wantOK: false},
		{name: "realtime protocol only", protocols: "realtime", wantOK: false},
		{name: "responses with insecure key", protocols: "responses, openai-insecure-api-key.sk-test", wantKey: "sk-test", wantOK: true},
		{name: "realtime with beta and insecure key", protocols: "realtime, openai-insecure-api-key.sk-realtime, openai-beta.realtime-v1", wantKey: "sk-realtime", wantOK: true},
		{name: "empty insecure key", protocols: "responses, openai-insecure-api-key.", wantOK: false},
		{name: "bare insecure marker is not a key", protocols: "openai-insecure-api-key", wantOK: false},
	}
