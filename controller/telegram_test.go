...
func setupTelegramOAuthTest(t *testing.T) *telegramOAuthFixture {
	...
	previousAddress, previousSiteAddress, previousSiteOrigins := system_setting.ServerAddress, system_setting.SiteAddress, system_setting.SiteAllowedOrigins
	...
	*system_setting.GetTelegramSettings() = system_setting.TelegramSettings{ClientID: "12345", ClientSecret: "telegram-client-secret"}
	system_setting.ServerAddress, system_setting.SiteAddress, system_setting.SiteAllowedOrigins = "https://api.example.com", "https://example.com", ""
	t.Cleanup(func() {
		common.OptionMapRWMutex.Lock()
		...
		*system_setting.GetTelegramSettings() = previousSettings
		system_setting.ServerAddress, system_setting.SiteAddress, system_setting.SiteAllowedOrigins = previousAddress, previousSiteAddress, previousSiteOrigins
