...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"server_address":              system_setting.GetAPIAddress(),
		"api_address":                 system_setting.GetAPIAddress(),
		"site_address":                system_setting.GetSiteAddress(),
		"site_address_configured":     strings.TrimSpace(system_setting.SiteAddress) != "",
		"site_allowed_origins":        system_setting.GetSiteOrigins(),
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if _, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		link := fmt.Sprintf("%s/user/reset?email=%s&token=%s", system_setting.GetSiteAddress(), email, code)
